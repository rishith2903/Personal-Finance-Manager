...
public class DemoDataService {
    ...
    public void seedDemoData(String userId) {
        ...
        long existingTransactions = transactionRepository.findByUserId(userId).size();
    ...
    private List<Transaction> createSampleTransactions(String userId) {
        ...
        transactions.add(Transaction.builder()
                ...
                .category("Groceries")
                .type("debit")
                .transactionDate(today.minusDays(28))
        ...
        transactions.add(Transaction.builder()
                ...
                .category("Groceries")
                .type("debit")
                .transactionDate(today.minusDays(21))
        ...
        transactions.add(Transaction.builder()
                ...
                .category("Dining")
                .type("debit")
                .transactionDate(today.minusDays(25))
        ...
        transactions.add(Transaction.builder()
                ...
                .category("Dining")
                .type("debit")
                .transactionDate(today.minusDays(24))
        ...
        transactions.add(Transaction.builder()
                ...
                .category("Dining")
                .type("debit")
                .transactionDate(today.minusDays(18))
        ...
        transactions.add(Transaction.builder()
                ...
                .type("debit")
                .transactionDate(today.minusDays(27))
        ...
        transactions.add(Transaction.builder()
                ...
                .category("Transportation")
                .type("debit")
                .transactionDate(today.minusDays(12))
        ...
        transactions.add(Transaction.builder()
                ...
                .type("debit")
                .transactionDate(today.minusDays(22))
        ...
        transactions.add(Transaction.builder()
                ...
                .category("Entertainment")
                .type("debit")
                .transactionDate(today.minusDays(16))
        ...
        transactions.add(Transaction.builder()
                ...
                .category("Utilities")
                .type("debit")
                .transactionDate(today.minusDays(26))
        ...
        transactions.add(Transaction.builder()
                ...
                .category("Utilities")
                .type("debit")
                .transactionDate(today.minusDays(23))
        ...
        transactions.add(Transaction.builder()
                ...
                .category("Utilities")
                .type("debit")
                .transactionDate(today.minusDays(19))
        ...
        transactions.add(Transaction.builder()
                ...
                .category("Shopping")
                .type("debit")
                .transactionDate(today.minusDays(17))
        ...
        transactions.add(Transaction.builder()
                ...
                .category("Shopping")
                .type("debit")
                .transactionDate(today.minusDays(11))
        ...
        transactions.add(Transaction.builder()
                ...
                .category("Healthcare")
                .type("debit")
                .transactionDate(today.minusDays(13))
